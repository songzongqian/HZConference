    ...
    public int login(LoginParam loginParam)
    {
        ...
        switch (LoginCenter.getInstance().getServerType())
        {
            case LoginCenter.LOGIN_E_SERVER_TYPE_MEDIAX:
                ...
                Log.i("song","login服务器类型"+"LOGIN_E_SERVER_TYPE_MEDIAX");
                break;
            case LoginCenter.LOGIN_E_SERVER_TYPE_SMC:
                LoginCenter.getInstance().setSipPort(loginParam.getServerPort());
                Log.i("song","login服务器类型"+"LOGIN_E_SERVER_TYPE_SMC");
                serverInfo.setProxyPort(5061);
                serverInfo.setServerPort(5061);
